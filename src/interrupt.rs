...
use crate::{
	cpu::{Cpu, Privilege},
    csr::{Csr, MCAUSE, MEPC, MIDELEG, MSTATUS_MIE, MSTATUS_MPIE, MSTATUS_MPP, MTVAL, MTVEC, SCAUSE, SEPC, STVAL, STVEC, XSTATUS_SIE, XSTATUS_SPIE, XSTATUS_SPP},
};
...
impl Interrupt {
    ...
    pub fn take_trap(&self, cpu: &mut impl Cpu) {
            ...
            && cause != Interrupt::MachineTimerInterrupt.exception_code()
        {
            ...
            match previous_mode {
                Privilege::User => cpu.state_mut().write_mstatus(MSTATUS_MPP, Privilege::User as u32),
                Privilege::Supervisor => cpu.state_mut().write_mstatus(MSTATUS_MPP, Privilege::Supervisor as u32),
                Privilege::Machine => cpu.state_mut().write_mstatus(MSTATUS_MPP, Privilege::Machine as u32),
            }
        }
    }
}
